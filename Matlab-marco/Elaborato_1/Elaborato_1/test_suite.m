...
% Test specific code
    ...
    [~,out]= bisection_algorithm(fun,range);
...
% Test specific code
    ...
    [~,~,graf]= bisection_algorithm(fun,range);
...
% Test specific code
    ...
    fun=[];
    testCase.verifyError(@()bisection_algorithm(fun,range),'bisection_algorithm:EmptyFun')
end
...
% Test specific code
    ...
    range=[];
    testCase.verifyError(@()bisection_algorithm(fun,range),'bisection_algorithm:ErrorX0')
end
...
% Test specific code
    ...
    [fun,range] = getGlobalParameter;
    TOL = 1*10^-18;
    testCase.verifyWarning(@()bisection_algorithm(fun,range,TOL),'bisection_algorithm:TOLminEPS')
end
...
% Test specific code
    ...
    [fun,range] = getGlobalParameter;
    TOL = 10^-6;
    actSolution= bisection_algorithm(fun,range,TOL);
    expSolution= fzero(fun,range);
...
% Test specific code
    ...
    [fun,range] = getGlobalParameter;
    TOL = - eps;
    testCase.verifyError(@()bisection_algorithm(fun,range,TOL),'bisection_algorithm:ErrorTOL')
end
...
% Test specific code
    ...
    actSolution= bisection_algorithm(fun,range,TOL,NMAX);
    expSolution= fzero(fun,range);
...
% Test specific code
    ...
    TOL = eps;
    NMAX = 1500;
    testCase.verifyWarning(@()bisection_algorithm(fun,range,TOL,NMAX),'bisection_algorithm:WarningMaxNMAX')
end
...
% Test specific code
    [fun,~] = getGlobalParameter;
    range= [-4,4];
    testCase.verifyError(@()bisection_algorithm(fun,range),'bisection_algorithm:ValueDiscord')
end
...
function [func,range] = getGlobalParameter
    global x; global y;
    func = x;
    range = y;
end
